          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                       © {{ now()->year }} <a style="color: #252f40;" href="https://enopolybrands.com/"
                          class="font-weight-bold ml-1" target="_blank">Design </a> &amp; <a style="color: #252f40;"
                          href="https://enopolybrands.com/" class="font-weight-bold ml-1" target="_blank">Develop by Enopoly Team</a>
              </div>
              </p>
          </div>
      </div>
