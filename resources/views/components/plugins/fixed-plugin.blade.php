<div class="fixed-plugin">
    <a class="fixed-plugin-button text-white position-fixed px-3 py-2 " style="background-color:#000;">
    ...
    <div class="card shadow-lg ">
        <div class="card-header pb-0 pt-3 ">
            ...
            <div class="float-start">
                ...
                <p class="fw-bold" style="color:#000;">Be the part of our f*cking Team</p>
            </div>
            <div class="float-end mt-1">
                <button class="btn btn-link text-dark p-0 fixed-plugin-close-button fs-5 ">
        ...
        <div class=" blur shadow-blur mx-4 mt-n6" style="border-radius:11px;">
        <div class="row gx-4 ">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/bruce-mars.jpg" alt="..." class="w-80 border-radius-lg shadow-sm">
                        <a href="javascript:;"
        ...
        <div class="card-body pt-sm-3 pt-0 mt-3">
            <!-- Sidebar Backgrounds -->
            <div>
            ...
            <a href="javascript:void(0)" class="switch-trigger background-color">
                <div class="badge-colors my-2 text-start">
                    ...
                    <span class="badge filter bg-gradient-dark" style="color:#000;" data-color="dark" onclick="sidebarColor(this)"></span>
