                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('seniority-Super') }}">Company</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('seniority-Super') }}">Seniority Level</a></li>
                            <li class="breadcrumb-item active">Edit Seniority</li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="editSenior">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                            <label for="description" class="form-label">Seniority Level</label>
                                        ...
                                        <button type="submit" class="btn btn-primary w-sm mt-3 me-2">Update</button>
                                          <a wire:navigate href="{{ route('seniority-Super') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
