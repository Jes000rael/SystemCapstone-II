                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('employment-Super') }}">Company</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('employment-Super') }}">Employment Status</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                        ...
                                        <button type="submit" class="btn btn-primary w-sm mt-3 me-2">Update</button>
                                          <a wire:navigate href="{{ route('employment-Super') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
