 <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
      ...
      <div class="row mt-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">Enopoly</h5>
                    <p class="mb-5">Let our team of E-commerce specialists track and scale your automated store to unimaginable levels. </p>
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-gradient-warning border-radius-lg h-100">
                    ...
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <img class="w-100 position-relative z-index-2 h-100" src="../assets/img/blog_image_size.avif">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-2 ">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"  style="background-image: url('https://enopolyautomation.com/wp-content/uploads/2024/04/Image-1536x674-1.jpeg');">
              <span class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Work with the Teams</h5>
  ...
  @if (session('success'))
    <script>
        Swal.fire({
          title: '<strong class="text-center">Login</strong> <strong>Successfully</strong> ',
