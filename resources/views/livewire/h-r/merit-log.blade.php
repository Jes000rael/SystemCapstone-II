                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Merit Log</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title fs-5 mb-4">Merit Log <a href="" class="btn btn-primary btn-sm float-end ms-2">Add Merit Category</a> <a href="" class="btn btn-primary btn-sm float-end">Add Merit Type</a></h4>
                                        <div class="col-md-12">
