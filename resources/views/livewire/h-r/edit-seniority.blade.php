                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('seniority-Level') }}">Admin</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('seniority-Level') }}">Add Seniority</a></li>
...
@endif
                        ...
                        <form wire:submit.prevent="editseniority">

                                          
                        <div class="mb-3">
                                            <label for="description" class="form-label">Seniority</label>
                                        ...
                                        <div class="align-item-center d-flex justify-content-center">
                                          ...
                                          <a wire:navigate href="{{ route('seniority-Level') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
