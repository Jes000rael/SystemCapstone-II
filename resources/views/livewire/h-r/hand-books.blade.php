                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <form action="">
                                        ...
                                        <div class="mb-3">
                                            <label for="formrow-value" class="form-label">Link</label>
                                            <input type="url" class="form-control" id="formrow-value" placeholder="https://example.com" required>
                                            <!-- <div class="text-danger">Please fill this field</div> -->
                                        </div>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive all-users-datatable_length  nowrap w-100">
                                        <!-- <div id="dataTables_length" id="all-users-datatable_length"></div> -->
                                            ...
                                            <tr>
                                                <td>Dept-001</td>
                                                <td>Policies</td>
                                                <td>http//enopoly/handbook/policies</td>
                                                <td>11/11/2024</td>
