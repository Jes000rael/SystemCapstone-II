                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('hand-Book') }}">Add Handbook</a></li>
                            <li class="breadcrumb-item active">Edit Handbook</li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4 fs-5">Edit Handbook</h4>
...
<form wire:submit.prevent="edithand">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <textarea wire:model.live="description"  id="description" class="form-control" placeholder="Enter the description"></textarea>
                                        </div>
                                        ...
                                        <div class="align-item-center d-flex justify-content-center">
                                          ...
                                          <a wire:navigate href="{{ route('hand-Book') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
