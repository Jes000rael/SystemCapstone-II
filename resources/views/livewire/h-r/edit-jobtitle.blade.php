                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('jobtitle') }}">Admin</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('jobtitle') }}">Add Job Title</a></li>
...
@endif
                        ...
                        <div class="mb-3">
                                        ...
                                        <div class="align-item-center d-flex justify-content-center">
                                          ...
                                          <a wire:navigate href="{{ route('jobtitle') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
