                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('deduction') }}">Admin</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('deduction') }}">Deduction Log</a></li>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4 fs-5">Edit Deduction</h4>
...
@endif
                        ...
                        <form wire:submit.prevent="editDeduc">
                        ...
                        <div class="mb-3">
                                        ...
                                        <div class="align-item-center d-flex justify-content-center">
                                          ...
                                          <a wire:navigate href="{{ route('deduction') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
