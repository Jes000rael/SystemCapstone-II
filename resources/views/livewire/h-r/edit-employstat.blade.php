                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('employee-Status') }}">Admin</a></li>
                            <li class="breadcrumb-item"><a wire:navigate href="{{ route('employee-Status') }}">Add Employment Status</a></li>
                            <li class="breadcrumb-item active">Edit Employment Status</li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4 fs-5">Edit Employment Status</h4>
...
@endif
                        ...
                        <div class="mb-3">
                                            <label for="description" class="form-label">Employment Status</label>
                                        ...
                                        <div class="align-item-center d-flex justify-content-center">
                                          ...
                                          <a wire:navigate href="{{ route('employee-Status') }}" class="btn btn-secondary w-sm mt-3">Close</a>
                                        </div>
                                        </div>
                        </form>
